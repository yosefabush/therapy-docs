      ...
      <main className="mr-64">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <Card className={riskInsights.length > 0 ? 'border-red-200 bg-red-50' : ''}>
              <div className="flex items-center justify-between">
                ...
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${riskInsights.length > 0 ? 'bg-red-100' : 'bg-sage-100'}`}>
