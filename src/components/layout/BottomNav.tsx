...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-sage-200 md:hidden z-50 safe-area-bottom">
        ...
        {navigation.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={clsx(
                'flex flex-col items-center justify-center flex-1 h-full py-1 px-1 transition-colors duration-200',
                active
                  ? 'text-sage-700'
                  : 'text-clinical-400 hover:text-clinical-600'
              )}
            >
              <div className={clsx(
